...
exports.positionSeed = async function (knex) {
  ...
  await knex("positions").insert([
    ...
    { id: 4, name: "И.о. главного инженера", is_signer: 1, department_id: 3 },
    {
      id: 5,
    ...
    { id: 6, name: "И.о. начальника ООПЗ", is_signer: 1, department_id: 7 },
    { id: 7, name: "Юрисконсульт", is_signer: 1, department_id: 13 },
    { id: 8, name: "Начальник ОИТИБ", is_signer: 1, department_id: 8 },
    { id: 9, name: "Агент по снабжению", is_signer: 1, department_id: 1 },
    { id: 10, name: "atest", is_signer: 1, department_id: 1 },
    {
      id: 11,
    ...
    { id: 18, name: "Специалист по СМК", is_signer: 1, department_id: 10 },
    {
      id: 19,
    ...
    { id: 23, name: "Менеджер по продажам", is_signer: 1, department_id: 5 },
    { id: 24, name: "Менеджер по ГОЗ", is_signer: 1, department_id: 5 },
    { id: 25, name: "Менеджер по логистике", is_signer: 1, department_id: 5 },
    {
      id: 26,
    ...
    { id: 27, name: "Делопроизводитель", is_signer: 1, department_id: 5 },
    { id: 28, name: "Интернет-маркетолог", is_signer: 1, department_id: 5 },
    {
      id: 29,
    ...
    { id: 47, name: "Техник ВЦ", is_signer: 1, department_id: 8 },
    {
      id: 48,
    ...
    { id: 63, name: "Экономист", is_signer: 1, department_id: 7 },
