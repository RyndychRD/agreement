...
export const documentTypeViewsApi = createApi({
	reducerPath: "documentTypeViewsApi",
	tagTypes: [TAG_TYPE],
	endpoints: (build) => ({
...
} = documentTypeViewsApi;

export const useGetDocumentsTypeQueryHook = useGetDocumentsTypeQuery;
export const useGetDocumentTypeQueryHook = useGetDocumentTypeQuery;
export const useAddDocumentTypeMutationHook = useAddDocumentTypeMutation;
export const useUpdateDocumentTypeMutationHook = useUpdateDocumentTypeMutation;
export const useDeleteDocumentTypeMutationHook = useDeleteDocumentTypeMutation;
